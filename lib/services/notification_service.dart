...
class NotificationService {
  ...
  Stream<List<AppNotification>> getNotifications(String currentProfileId,
    ...
    return query.snapshots().map((snapshot) {
      return snapshot.docs
          .map((doc) =>
              AppNotification.fromMap(doc.id, doc.data() as Map<String, dynamic>))
          .toList();
    });
  }
  ...
  Stream<List<AppNotification>> streamActiveProfileNotifications() {
    return _ref.watch(profileProvider.stream).asyncMap((profileState) async {
