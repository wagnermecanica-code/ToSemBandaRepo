...
class ProfileSwitcherBottomSheet extends ConsumerWidget {
                ...
                final profiles = snapshot.data?.docs
                    .map((doc) {
                      try {
                        ...
                        debugPrint('Erro ao converter perfil ${doc.id}: $e');
                        return null;
                      }
                    })
                    .where((p) => p != null)
                        ...
                        ElevatedButton.icon(
                          onPressed: () async {
                            ...
                            final result = await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const EditProfilePage(isNewProfile: true),
                              ),
                            );
                            ...
                            leading: Hero(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: profile.photoUrl != null && profile.photoUrl!.isNotEmpty
                                    ? CachedNetworkImageProvider(profile.photoUrl!) as ImageProvider
                                    : null,
                            ...
                            onTap: isActive
                                ...
                                : () async {
                                    ...
                                    try {
                                      ...
                                      final overlayFuture = ProfileTransitionOverlay.show(
                                        context,
                                      ...
                                      await Future.wait([
                                        profileRepository.switchActiveProfile(profile.profileId),
                                        Future.delayed(const Duration(milliseconds: 1300)), // Duração mínima do overlay
                                      ]);
  ...
  void _editProfile(BuildContext context, Profile profile) async {
    ...
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => EditProfilePage(profileIdToEdit: profile.profileId),
      ),
    );
