...
class _SettingsPageState extends ConsumerState<SettingsPage> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // Seção: Notificações
          const SettingsSection(title: 'Notificações', icon: Icons.notifications_outlined),
          const SizedBox(height: 12),
          SettingsSwitchTile(
          ...
          // Seção: Conta
          const SettingsSection(title: 'Conta', icon: Icons.account_circle_outlined),
          const SizedBox(height: 12),
          SettingsTile(
            icon: Icons.logout,
            title: 'Sair da Conta',
  ...
  Future<void> _performLogout() async {
    ...
    try {
      ...
      debugPrint('🔄 SettingsPage: authStateProvider detectará mudança e mostrará AuthPage automaticamente');
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                const SizedBox(width: 12),
                Expanded(child: Text('Erro ao sair: ${e.toString()}')),
              ],
            ),
            backgroundColor: AppColors.error,
