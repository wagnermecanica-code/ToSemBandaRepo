...
mixin _$PostEntity {
  ...
  String get content =>
      throw _privateConstructorUsedError; // 'message' in old code
  @GeoPointConverter()
  ...
  String get type => throw _privateConstructorUsedError; // 'band' or 'musician'
  ...
  @TimestampConverter()
  DateTime get expiresAt => throw _privateConstructorUsedError; // 30 days after creation
...
class _$PostEntityImpl extends _PostEntity {
  ...
  @override
  String toString() {
    return 'PostEntity(id: $id, authorProfileId: $authorProfileId, authorUid: $authorUid, content: $content, location: $location, city: $city, neighborhood: $neighborhood, state: $state, photoUrl: $photoUrl, youtubeLink: $youtubeLink, type: $type, level: $level, instruments: $instruments, genres: $genres, seekingMusicians: $seekingMusicians, availableFor: $availableFor, createdAt: $createdAt, expiresAt: $expiresAt, distanceKm: $distanceKm)';
  }
...
abstract class _PostEntity extends PostEntity {
  ...
  @override
  String get content; // 'message' in old code
  @override
  @GeoPointConverter()
  ...
  @override
  String get type; // 'band' or 'musician'
  @override
  String get level;
  @override
  List<String> get instruments;
  ...
  @override
  @TimestampConverter()
  DateTime get expiresAt; // 30 days after creation
  @override
