...
abstract class IPostRemoteDataSource {
  ...
  Future<void> addInterest(String postId, String profileId, String authorProfileId);
...
class PostRemoteDataSource implements IPostRemoteDataSource {
  ...
  Future<bool> hasInterest(String postId, String profileId) async {
    try {
      debugPrint('🔍 PostDataSource: hasInterest - post=$postId, profile=$profileId');
  ...
  Future<void> addInterest(
    ...
    try {
      debugPrint('💚 PostDataSource: addInterest - post=$postId, profile=$profileId');
  ...
  Future<void> removeInterest(String postId, String profileId) async {
    try {
      debugPrint('💔 PostDataSource: removeInterest - post=$postId, profile=$profileId');
  ...
  Future<List<PostEntity>> getNearbyPosts({
    ...
    try {
      debugPrint('🔍 PostDataSource: getNearbyPosts - lat=$latitude, lng=$longitude, radius=$radiusKm');
  ...
  Stream<List<PostEntity>> watchPostsByProfile(String profileId) {
    try {
      debugPrint('👁️ PostDataSource: watchPostsByProfile - profileId=$profileId');
