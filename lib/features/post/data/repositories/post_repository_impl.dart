...
class PostRepositoryImpl implements PostRepository {
  ...
  Future<void> deletePost(String postId, String profileId) async {
    try {
      debugPrint('📝 PostRepository: deletePost - postId=$postId, profileId=$profileId');
  ...
  Future<bool> hasInterest(String postId, String profileId) async {
    try {
      debugPrint('📝 PostRepository: hasInterest - postId=$postId, profileId=$profileId');
  ...
  Future<void> addInterest(String postId, String profileId) async {
    try {
      debugPrint('📝 PostRepository: addInterest - postId=$postId, profileId=$profileId');
  ...
  Future<void> removeInterest(String postId, String profileId) async {
    try {
      debugPrint('📝 PostRepository: removeInterest - postId=$postId, profileId=$profileId');
  ...
  Future<List<PostEntity>> getNearbyPosts({
    ...
    try {
      debugPrint('📝 PostRepository: getNearbyPosts - lat=$latitude, lng=$longitude');
  ...
  Stream<List<PostEntity>> watchPostsByProfile(String profileId) {
    try {
      debugPrint('📝 PostRepository: watchPostsByProfile - profileId=$profileId');
