...
class _EditPostPageState extends State<EditPostPage> {
  ...
  Future<void> _fetchLocationDetails(LatLng location) async {
    try {
      ...
      debugPrint('🔍 Buscando detalhes da localização: ${location.latitude}, ${location.longitude}');
          ...
          if (mounted) {
            setState(() {
              ...
              if (parts.isNotEmpty) {
                ...
                debugPrint('✅ Campo de localização atualizado: ${_locationSearchController.text}');
              } else {
                                              ...
                                              Expanded(
                                                child: Text(
                                                  () {
                                                    ...
                                                    return parts.isNotEmpty ? parts.join(', ') : 'Localização validada';
                                                  }(),
