  ...
  void _loadExistingFilters() {
    ...
    if (currentParams != null) {
      ...
      _selectedAvailableFor
        ..clear()
        ..addAll(currentParams.availableFor);
      _selectedGenres
        ..clear()
      ...
      _hasYoutube = currentParams.hasYoutube;
    }
  }
              ...
              children: [
                Expanded(
                  child: _TypeFilterButton(
                    ...
                    onTap: () {
                      setState(() {
                        _selectedPostType = _selectedPostType == 'musician' ? null : 'musician';
                      });
                    },
                  ),
                ),
                ...
                Expanded(
                  child: _TypeFilterButton(
                    ...
                    onTap: () {
                      setState(() {
                        _selectedPostType = _selectedPostType == 'band' ? null : 'band';
                      });
                    },
                  ),
                ),
