...
import 'package:to_sem_banda/features/messages/presentation/pages/chat_detail_page.dart';
...
class _NotificationsPageState extends ConsumerState<NotificationsPage>
  ...
  Widget _buildNotificationsList(
    ...
    return StreamBuilder<List<AppNotification>>(
      stream: ref.read(notificationServiceProvider).getNotifications(currentProfileId, type: type),
      builder: (context, snapshot) {
              ...
              SnackBar(
                content: Row(
                  children: [
                    ...
                    Text('Erro ao remover: ${e.toString()}'),
                  ],
                ),
