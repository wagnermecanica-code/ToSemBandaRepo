...
mixin _$MessageEntity {
  ...
  MessageReplyEntity? get replyTo => throw _privateConstructorUsedError;
...
abstract class $MessageReplyEntityCopyWith<$Res> {
  factory $MessageReplyEntityCopyWith(
          MessageReplyEntity value, $Res Function(MessageReplyEntity) then) =
...
abstract class _$$MessageReplyEntityImplCopyWith<$Res>
    implements $MessageReplyEntityCopyWith<$Res> {
  factory _$$MessageReplyEntityImplCopyWith(_$MessageReplyEntityImpl value,
...
class __$$MessageReplyEntityImplCopyWithImpl<$Res>
  ...
  __$$MessageReplyEntityImplCopyWithImpl(_$MessageReplyEntityImpl _value,
  ...
  $Res call({
    ...
    return _then(_$MessageReplyEntityImpl(
      messageId: null == messageId
          ? _value.messageId
          : messageId // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$MessageReplyEntityImpl extends _MessageReplyEntity {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$MessageReplyEntityImplToJson(
      this,
    );
  }
}
...
abstract class _MessageReplyEntity extends MessageReplyEntity {
  const factory _MessageReplyEntity(
      ...
      required final String text,
      required final String senderId,
      final String? senderProfileId}) = _$MessageReplyEntityImpl;
